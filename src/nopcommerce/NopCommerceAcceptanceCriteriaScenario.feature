...
Asa user, I would like to check acceptance criteria of Nopcommerce top menu
  ...
  Scenario: Verify that use can see the Books category page with filters and list of products
    When  User is on given URL
  ...
  Scenario: Verify that user can see 'Display' filter on Book Category page
    Given User in on Books Category page
    When  User is on Books Category page
    And   Check 'Display' filter is
